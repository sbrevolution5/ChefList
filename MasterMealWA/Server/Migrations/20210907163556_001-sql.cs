...
{
    public partial class _001sql : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageId = table.Column<int>(type: "int", nullable: false),
                    RecipeSource = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RecipeSourceUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeasurementType = table.Column<int>(type: "int", nullable: false),
                    MassMeasurementUnit = table.Column<int>(type: "int", nullable: true),
                    VolumeMeasurementUnit = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IngredientId = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    QuantityString = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InPantry = table.Column<bool>(type: "bit", nullable: false),
