...
namespace MasterMealWA.Server.Migrations
{
    ...
    [Migration("20211102184227_024-ShoppingOnly")]
    partial class _024ShoppingOnly
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChefSupply", b =>
                {
                    b.Property<int>("ChefSuppliesId")
                        .HasColumnType("integer");

                    b.Property<string>("ChefsId")
                        .HasColumnType("text");

                    b.HasKey("ChefSuppliesId", "ChefsId");

                    b.HasIndex("ChefsId");

                    b.ToTable("ChefSupply");
                });
            ...
            modelBuilder.Entity("MasterMealWA.Shared.Models.Social.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ChefSupply", b =>
                {
                    b.HasOne("MasterMealWA.Shared.Models.Supply", null)
                        .WithMany()
                        .HasForeignKey("ChefSuppliesId")
