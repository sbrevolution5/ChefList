...
namespace MasterMealWA.Server.Controllers
{
    ...
    public class RecipesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Recipe>>> GetRecipe()
        {
            ...
            {
                return await _context.Recipe.Include(r => r.Author).Include(r => r.Ratings).Include(r => r.Image).Include(r=>r.Supplies).ThenInclude(s=>s.Supply).Where(r => !r.IsPrivate).Include(r => r.Tags).ToListAsync();
            }
